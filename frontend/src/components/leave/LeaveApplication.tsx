...
const LeaveApplication: React.FC = () => {
  ...
  const onSubmit = async (data: LeaveFormData) => {
    ...
    if (data.leaveTypeId === 1 && balance && days > balance.remainingDays) {
      alert(`Insufficient annual leave balance. You have ${balance.remainingDays} days remaining.`);
      return;
    }
    ...
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          {/* Leave Balance Info */}
          {balance && (selectedType === 1 || !selectedType) && (
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-4">
            ...
            <div className={selectedType === 1 ? "border-t border-gray-200 pt-4" : ""}>
